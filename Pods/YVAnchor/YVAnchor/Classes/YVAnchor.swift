...
extension YVAnchor where Self: UIView {
    ...
    @discardableResult
    public func height(equalTo dimension: NSLayoutDimension, multiplier: CGFloat) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    @discardableResult
    public func width(equalTo dimension: NSLayoutDimension, multiplier: CGFloat) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
